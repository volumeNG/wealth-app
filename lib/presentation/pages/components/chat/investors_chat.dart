...
class InvestorChat extends ConsumerStatefulWidget {
  const InvestorChat({Key? key}) : super(key: key);

  @override
  ConsumerState<InvestorChat> createState() => _InvestorChatState();
}

class _InvestorChatState extends ConsumerState<InvestorChat> {
  @override
  Widget build(BuildContext context) {
    AsyncValue<List<ChatGroup>> adminChats = ref.watch(getChatLists("public"));

    return Scaffold(
      body: adminChats.when(
        data: (data) {
          if (data.isNotEmpty) {
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    getTimeFromDateAndTime(data[index].updatedAt.toString()),
