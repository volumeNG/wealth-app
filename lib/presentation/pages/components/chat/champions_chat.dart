...
class ChampionsChat extends ConsumerStatefulWidget {
  const ChampionsChat({Key? key}) : super(key: key);

  @override
  ConsumerState<ChampionsChat> createState() => _ChampionsChatState();
}

class _ChampionsChatState extends ConsumerState<ChampionsChat> {
  @override
  Widget build(BuildContext context) {
    AsyncValue<List<ChatGroup>> adminChats =
        ref.watch(getChatLists("champion"));
